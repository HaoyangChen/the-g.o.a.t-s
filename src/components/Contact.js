    ...
    <main>
      ...
      <Container>
        <Row style={{ paddingTop: "2em" }}>
          <Col lg={7}>
            <p align="left">
              This project is created as part of the final for Informatics 442.
              Our mission is to create a solution to allow the general public to
              obtain accurate information concerning Human and Sex Trafficking
              in one location.{" "}
            </p>
            <p align="left">
              Each member worked to contribute to Sanctuary based on their own
              personal skills and strengths. If you wish to contact a member of
              the team click on the button located below their photo and
              description.
            </p>
          </Col>
          <Col lg={5}>
            ...
            <Card style={{ width: "18rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text align="left">
                  ...
                  <p>
                    A senior at the University of Washington studying
                    Informatics. Passionate about developing solutions for
                    social good.{" "}
                  </p>
                </Card.Text>
                <Button
              ...
              <Card.Body>
                ...
                <Card.Text align="left">
                  ...
                  <p>
                    ...
                    majoring in Informatics and minoring in Entrepreneurship.
                  </p>
                </Card.Text>
                <Button
                  style={{
            ...
            <Card style={{ width: "18rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text align="left">
                  ...
                  <p>
                    I'm a senior at the University of Washington Seattle
                    studying Informatics and English, set to graduate in
                    December 2020.
                  </p>
                </Card.Text>
                <Button
            ...
            <Card style={{ width: "18rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text align="left">
                  <h5 style={{ color: "#4C4AC2" }}>UX/UI Designer </h5>
                  <p>
                    Currently a senior at the University of Washington studying
                    Informatics with a focus on human computer interaction.{" "}
                  </p>
                </Card.Text>
                <Button
                  style={{
