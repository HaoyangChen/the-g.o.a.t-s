    ...
    <main>
      ...
      <Container>
        <Row style={{ paddingTop: '2em' }}>
          ...
          <Col lg={5}><img src='team.svg' height='190'></img></Col>
        </Row>
        <Row style={{ padding: '1em' }}>
          <Col lg={4} align="left" style={{ padding: '1em' }}>
            <Card style={{ width: '18rem' }}>
              <Card.Img variant="top" src="meesha.jpeg" height="200" />
              <Card.Body>
                <Card.Title align="left"><h3>Meesha Hussian</h3></Card.Title>
                <Card.Text align="left">
                  <h5 style={{ color: "#4C4AC2" }}>Project Manager/Developer</h5>
                  <p>A designer/researcher passionate about making existing solutions more pertinent to the goals of underrepresented user groups.</p>
                </Card.Text>
                <Button style={{ backgroundColor: '#F5F5F5', borderColor: "#F5F5F5", color: "#4C4AC2" }}>Contact Me</Button>
              </Card.Body>
            </Card>
          </Col>
          <Col align="left" style={{ padding: '1em' }}>
            <Card style={{ width: '18rem' }}>
              <Card.Img variant="top" src="haoyang.jpeg" height="200" />
              <Card.Body>
          ...
          <Col lg={4} align="left" style={{ padding: '1em' }}>
            <Card style={{ width: '18rem' }}>
              <Card.Img variant="top" src="rahma.jpg" height="200" />
              <Card.Body>
                <Card.Title align="left"><h3>Rahma Kamel</h3></Card.Title>
                <Card.Text align="left">
                  <h5 style={{ color: "#4C4AC2" }} >Project Manager/Developer </h5>
                  <p>Hi! I am currently a Senior at the University of Washington majoring in Informatics and minoring in Entrepreneurship.</p>
                </Card.Text>
                <Button style={{ backgroundColor: '#F5F5F5', borderColor: "#F5F5F5", color: "#4C4AC2" }} href={`mailto:kamelr@uw.edu`}>Contact Me</Button>
              </Card.Body>
            </Card>
          </Col>
          <Col lg={4} align="left" style={{ padding: '1em' }}>
            <Card style={{ width: '18rem' }}>
              <Card.Img variant="top" src="salem.jpeg" height="200" />
              <Card.Body>
                ...
                <Button style={{ backgroundColor: '#F5F5F5', borderColor: "#F5F5F5", color: "#4C4AC2" }} href={`mailto:salemg@uw.edu`}>Contact Me</Button>
              </Card.Body>
            </Card>
          </Col>
          <Col align="left" style={{ padding: '1em' }}>
            <Card style={{ width: '18rem' }}>
              <Card.Img variant="top" src="rawuda.jpeg" height="200" />
              <Card.Body>
